...
export function SettingsScreen({ menu, onSaveMenu, settings, onSaveSettings, orders, onRestoreBackup }) {
  ...
  return <ScrollView contentContainerStyle={styles.container}>
    ...
    <View style={styles.card}>
      <View style={styles.cardHeader}><View><Text style={styles.cardTitle}>Menu & Categories</Text><Text style={styles.help}>Add, edit, remove or temporarily sell out items.</Text></View><TouchableOpacity style={styles.smallAdd} onPress={() => setEditingCategory({ isNew: true, name: '' })}><Text style={styles.smallAddText}>+ CATEGORY</Text></TouchableOpacity></View>
